...
public class ConcordiumClient : IDisposable
{
    ...
    public ConcordiumClient(Uri endpoint, UInt16 port, ClientConfiguration configuration)
    {
        ...
        Raw = new RawClient(InternalClient, GrpcChannel, Config);
    }
    ...
    public class RawClient : IDisposable
    {
        ...
        public RawClient(
            Queries.QueriesClient InternalClient,
        ...
        {
            return InternalClient
                .InstanceStateLookupAsync(input, CreateCallOptions())
                .ResponseAsync;
        }
        ...
        {
            return InternalClient
                .GetConsensusInfoAsync(new Empty(), CreateCallOptions())
                .ResponseAsync;
        }
        ...
        {
            return InternalClient
                .GetBannedPeersAsync(new Empty(), CreateCallOptions())
                .ResponseAsync;
        }
