...
public class ConcordiumNodeClient : IConcordiumNodeClient, IDisposable
{
    ...
    public async Task<bool> BanNodeAsync(
        string? ip,
        string? nodeId,
        ...
        uint? port = null)
    {
        ...
        BoolResponse response = await _client.BanNodeAsync(request, CreateCallOptions());
        return response.Value;
    }
    ...
    public async Task<bool> LeaveNetworkAsync(int networkId)
    {
        NetworkChangeRequest request = new NetworkChangeRequest
        {
            NetworkId = networkId
        };
        BoolResponse response = await _client.LeaveNetworkAsync(request, CreateCallOptions());
        return response.Value;
    }
