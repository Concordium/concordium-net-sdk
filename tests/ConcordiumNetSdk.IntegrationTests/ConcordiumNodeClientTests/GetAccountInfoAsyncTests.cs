...
public class GetAccountInfoAsyncTests
{
    ...
    public async Task When_account_exists_should_return_correct_data()
    {
        ...
        var emptyAccountInfo = new AccountInfo();
        var accountAddress = new AccountAddress("32gxbDZj3aCr5RYnKJFkigPazHinKcnAhkxpade17htB4fj6DN");
        var blockHash = new BlockHash("44c52f0dc89c5244b494223c96f037b5e312572b4dc6658abe23832e3e5494af");
        ...
        accountInfo.Should().NotBeEquivalentTo(emptyAccountInfo);
    }
}
